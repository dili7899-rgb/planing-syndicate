...
def get_db_connection():
    # REPLACE THE STRING BELOW WITH YOUR ACTUAL SUPABASE CONNECTION STRING
    db_url = "postgresql://postgres.dchtyvecwdrtbtbdxzgg:medun20000cyber@aws-1-eu-central-1.pooler.supabase.com:6543/postgres"
